...
class KeycloakSettingsTestCase(TestCase):
    ...
    def test_default_settings(self):
        ...
        # default settings
        self.assertEqual(keycloak_settings.CLIENT_ID, None)
        self.assertEqual(keycloak_settings.CLIENT_SECRET, None)
        self.assertEqual(keycloak_settings.AUDIENCE, "account")
        self.assertEqual(keycloak_settings.VERIFY_TOKENS_WITH_KEYCLOAK, False)
        ...
        self.assertEqual(keycloak_settings.CLAIM_MAPPING, {
    ...
    @override_settings(KEYCLOAK_CONFIG={"SERVER_URL": "https://foo.com", "REALM": "bar"})
